...
public class UserControllerTest extends AbstractControllerTest {
    ...
    public void updateUser_succeed() throws Exception {
        ...
        ResultActions result = mockMvc.perform(put(urlPath).accept(MediaType.APPLICATION_JSON).headers(createHeaders("Kinvey a2lkX1prLWZBQUVod2c6Zjk1M2ZjYTZiYWFmNGJkMWI0MTExZDNhOTA1ZmIyMzg=")).content(jsonResponse));
        validateUserResponse(expectedUser, result);
    ...
    public void updateUser_failed401() throws Exception {
        ...
        mockMvc.perform(put(urlPath).accept(MediaType.APPLICATION_JSON).headers(createHeaders("Kinvey a2lkX1prLWZBQUVod2c6Zjk1M2ZjYTZiYWFmNGJkMWI0MTExZDNhOTA1ZmIyMzg=")).content(jsonResponse)).andExpect(status().isUnauthorized());
    ...
    public void getUserFromSpace_succeed() throws Exception {
        ...
        getUserFromSpace_succeed(expectedUser, urlPath);
    }
    ...
    private void getUserFromKinvey_succeed(User expectedUser, String urlPath) throws Exception {
        ...
        assertNull(chinaSpace.readIfExists(userTemplate));
        assertNull(usSpace.read(new KinveyAsyncGetRequest()));
    }
